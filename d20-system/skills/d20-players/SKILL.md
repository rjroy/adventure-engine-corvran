---
name: d20-players
description: This skill should be used when the user asks to "create a character", "roll for stats", "assign ability scores", "level up", "increase hit points", "choose a class", "pick proficiencies", or needs guidance on player character creation, advancement, or character sheet management. Provides templates and rules for SRD 5.2 character creation and leveling.
---
