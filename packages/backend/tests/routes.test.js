...
describe("GET /help", () => {
    test("returns all registered operations", async () => {
        ...
        const opIds = body.operations.map((op) => op.operationId);
